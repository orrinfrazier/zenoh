...
/// An RPC client that sends typed method calls to a remote [`ServiceServer`](super::ServiceServer).
///
...
/// ```ignore
/// use std::time::Duration;
/// use zenoh_ext::rpc::ServiceClient;
///
...
impl ServiceClient {
    ...
    where
        Req: crate::serialization::Serialize,
        Resp: crate::serialization::Deserialize,
    {
